...
export const withStyle = {
	error: (str: string) => `${chalk.fn(`${chalk.fn(' Invalid input ')} ${str}`)}`,
	warning: (str: string) => `${chalk.fn(' Warning ')} ${str}`,
	errorWarning: (str: string) => `${chalk.fn(`${chalk.fn(' Warning ')} ${str}`)}`,
	fullWarning: (str: string) => `${chalk.fn(' Warning ')} ${chalk.fn(str)}`,
	suggestion: (str: string) => `${chalk.fn(' Suggestion ')} ${str}`,
	info: (str: string) => `${chalk.fn(str)}`,
};
